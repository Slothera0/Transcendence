export const profileActionTemplate = (x: number, y: number) => `
  <div id="profile-popup" style="position:fixed; top:max(10px, ${y - 10}px); left:${x}px; z-index:50;"
    ...
    <div class="flex flex-col gap-2 w-full h-full px-2 py-2 break-words whitespace-normal overflow-auto">
     <button id="profile" class="friends-profile-btn w-full text-black">Profile</button>
    </div>
  </div>
`;